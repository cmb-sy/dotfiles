...
| 話速 | 180 wpm (macOS say デフォルト、ゆっくり聴き取り重視) |
...
│    shell_command: $HOME/dotfiles/bin/voice-out    │
└───────────────────────┬───────────────────────────┘
                        ↓
┌───────────────────────────────────────────────────┐
│  bin/voice-out                                     │
...
| `-r 180` | macOS say デフォルト値、ゆっくり聴き取りを優先 |
...
{
  "session_id": "3ce50f05-...",
  "transcript_path": "$HOME/.claude-work/projects/.../session.jsonl",
...
[キー押下] Caps Lock + Z
    ...
    │
[起動] $HOME/dotfiles/bin/voice-out
    │
