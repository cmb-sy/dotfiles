...
- 選択肢:
  ...
  2. **Obsidian vault** — `$HOME/develop/obsidian/03_skillup/learn/YYYY-MM-DD-<topic>.md`。プロジェクト横断の個人学習ログとして vault に集約する
...
選択した保存先（`docs/learnings/` または Obsidian vault の `03_skillup/learn/`）を確認し、同一トピックの重複を避ける。既存と同テーマなら別角度のテーマを選ぶか追補方針を決める。
...
- Obsidian vault 選択時: `$HOME/develop/obsidian/03_skillup/learn/YYYY-MM-DD-number.md`
