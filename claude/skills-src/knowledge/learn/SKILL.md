...
6. 実装解説 + 技術解説 + **ゼロベース用語解説** + 判断背景を統合し、選択した保存先の `YYYY-MM-DD-<topic>.md` に出力する
7. 教材保存後、「理解度クイズ」節に従い `generate-problem` を起動する
...
1. **素材の組み立て**: 実装要約（1–3文）+ メイントピック名 + ゼロベース用語リスト（Step 2.3 の結果）を1つのテキストにまとめる
2. **起動ゲート**:
